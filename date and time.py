...
# Connect to the Ubuntu VM and display the system info
def show_system_info():
    ubuntu_device = {
        'device_type': 'linux',
        'host': '10.0.2.15',         # Replace with your Ubuntu VM IP address
        'username': 'vboxuser',      # Replace with your Ubuntu username
        'password': 'changeme',      # Replace with your password or use SSH key authentication
        'port': 22,                  # Default SSH port
        'secret': 'changeme',        # Optional: if you have a 'sudo' password
    }
#................................................................##########################
    try:
...
#.............................................................................................................................#
# Show the home directory of the current user
def home_directory():
    try:
        home_directory_path = os.path.expanduser("~")
        print("Home Directory: ", home_directory_path)
    except Exception as e:
        print(f"An error occurred while fetching the home directory: {e}")
